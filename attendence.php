  ...
  <div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button"><span class="fa fa-plus"></span><a href="qr_attendance.php" style="color:white;text-decoration:none;">Add Attendance</a> </button>
        <button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button"><span class="fa fa-plus"></span><a href="qrcode.php" style="color:white;text-decoration:none;"> Generate QR Code</a></button>
